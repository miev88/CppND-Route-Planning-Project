...
static float GetUserInput(std::string loc)
{
    int int_number;
    std::cout << "Enter an int for " << loc << " in range [0, 100]: ";
    std::cin >> int_number;
    while(int_number < 0 || int_number > 100 || std::cin.fail()) {
        std::cout << "Input is invalid! Enter an int for " << loc << " in range [0, 100]: ";
